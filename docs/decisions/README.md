...
| [0003](0003-s3-object-lock-as-the-record.md) | S3 Object Lock in compliance mode is the record; everything else is a projection | accepted; the `record` tier of [0014](0014-lock-modes-and-store-tiers.md), which adds an `attested` tier beside it |
